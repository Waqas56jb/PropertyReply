...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] relative z-[2] w-full py-32 px-[5%] text-center animate-fadeInUp max-md:py-28 max-md:px-4 max-sm:py-24 max-sm:px-3">
        ...
        <h1 className="font-display text-[clamp(2.4rem,5.5vw,4.75rem)] font-extrabold leading-[1.05] text-white mb-6 tracking-[-2px] max-md:text-[clamp(2rem,8vw,2.9rem)] max-md:mb-5 max-md:tracking-[-1px] max-sm:text-[clamp(1.85rem,9vw,2.5rem)] max-sm:mb-4 max-sm:tracking-[-0.5px]">
        ...
        <p className="text-[clamp(1rem,2.3vw,1.3rem)] text-white/85 max-w-[720px] mx-auto mb-10 leading-[1.8] font-normal max-md:text-[clamp(0.95rem,3vw,1.1rem)] max-md:mb-8 max-md:leading-[1.7] max-sm:text-[clamp(0.9rem,3.5vw,1rem)] max-sm:mb-7 max-sm:leading-[1.65]">
          Capture buyers and sellers the moment they land on your site. Turn website visitors into booked viewings and valuation requests — even after hours.
        </p>

        <div className="flex gap-4 items-center justify-center flex-wrap mb-10 max-md:flex-col max-md:items-stretch max-md:gap-3 max-md:w-full max-md:mb-8">
          <button
            onClick={handleCTAClick}
            className="px-10 py-4 rounded-full font-semibold text-[0.98rem] cursor-pointer transition-all duration-300 border-none font-sans relative overflow-hidden inline-flex items-center justify-center gap-3 tracking-wide bg-gradient-primary text-white shadow-primary hover:-translate-y-0.5 hover:shadow-primary-hover max-md:w-full max-md:justify-center"
          >
        ...
        <div className="flex items-center justify-center gap-4 text-white/60 text-[0.8rem] mb-12">
